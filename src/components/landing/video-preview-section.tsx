  ...
  return (
    <section className="bg-white px-6 py-14 lg:px-10 lg:py-20">
      <div className="mx-auto grid max-w-[1180px] gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
        <AnimatedSection>
          <span className="rounded-full bg-[#391B68]/10 px-4 py-2 text-[13px] font-black text-[#391B68]">
            {copy.hero.eyebrow}
          </span>
          <h2 className="mt-5 text-3xl font-black leading-tight text-[#391B68] lg:text-5xl">{copy.videoPreview.title}</h2>
