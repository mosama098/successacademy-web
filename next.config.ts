...
const contentSecurityPolicyReportOnly = [
  ...
  `img-src 'self' data: blob: https://www.googletagmanager.com https://*.google-analytics.com https://www.google.com https://*.google.com https://www.facebook.com https://analytics.tiktok.com https://aanlytics-ipv6.tiktokw.us https://${storyblokAssetHostname} https://*.wistia.com https://*.wistia.net`,
  "font-src 'self' data: https://*.wistia.com",
  "connect-src 'self' https://www.googletagmanager.com https://www.google.com https://*.google-analytics.com https://analytics.google.com https://*.analytics.google.com https://stats.g.doubleclick.net https://www.facebook.com https://connect.facebook.net https://analytics.tiktok.com https://aanlytics-ipv6.tiktokw.us https://*.litix.io https://*.wistia.com https://*.wistia.net https://*.algolia.net",
